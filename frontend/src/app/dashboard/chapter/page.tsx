...
import {
    ...
    Megaphone, Lightbulb, Clock, AlertCircle, Send, Pencil, Trash2, ShieldCheck,
} from "lucide-react";
...
export default function MyChapterPage() {
    ...
    const [activeTab, setActiveTab] = useState<"feed" | "news" | "members">("news");
    ...
    const fetchAll = useCallback(async () => {
        ...
        setLoading(true);
        try {
            const [chapterRes, membersRes, activitiesRes, feedRes] = await Promise.allSettled([
        ...
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] gap-4 text-center p-8">
                ...
                <p className="text-tatt-gray max-w-sm text-sm">
                    You haven't been assigned to a chapter yet. Contact the TATT admin team to get assigned to your local chapter.
                </p>
            </div>
        );
    }
