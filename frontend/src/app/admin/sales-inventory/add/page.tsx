            ...
            <div className="max-w-4xl space-y-8 pb-32">
                ...
                <div>
                    ...
                    <p className="text-tatt-gray font-bold text-xs uppercase tracking-widest mt-2">
                        Configure your luxury product details for the global marketplace.
                    </p>
                </div>
                ...
                <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 px-2">
                    ...
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                        <button 
                            ...
                            disabled={loading}
                            className="flex-1 sm:flex-none px-8 py-3.5 rounded-2xl border border-border text-foreground font-black text-[10px] uppercase tracking-widest hover:bg-background transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
                        >
