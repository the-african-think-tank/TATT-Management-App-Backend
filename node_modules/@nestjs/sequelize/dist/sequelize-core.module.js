...
let SequelizeCoreModule = SequelizeCoreModule_1 = class SequelizeCoreModule {
    ...
    static forRoot(options = {}) {
        ...
        const connectionProvider = {
            provide: (0, common_2.getConnectionToken)(options),
    ...
    async onApplicationShutdown() {
        if (typeof this.options.autoCloseConnection !== 'undefined' &&
            !this.options.autoCloseConnection) {
            return;
        }
        const connection = this.moduleRef.get((0, common_2.getConnectionToken)(this.options));
        if (connection) {
