    ...
    private async seedPlans() {
        const plans = [
            ...
            },
            {
                ...
                yearlyPrice: 875,
                features: [
                    'All Imani features (for designated representative)',
                    'Annual Business Spotlight Feature',
                    'Logo Placement & Ecosystem Promotion',
                    'Free Vendor Tables at Growth Mindset Mixers',
                    'Premium Pitch Event Access',
                    'Employer Visibility in TATT Network',
                    'Workforce DBU Academy Licenses (save $300/employee)',
                    'Premium Networking Access',
                    'Official TATT T-Shirt',
                    'Digital Business Member ID Card'
                ],
                isPopular: false,
